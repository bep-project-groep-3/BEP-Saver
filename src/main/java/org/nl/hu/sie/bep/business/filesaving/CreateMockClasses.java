...
public class CreateMockClasses {
    public static BedrijfRow createMockClasses() {
        ...
        FactuurRegelRow factuurRegel2 = new FactuurRegelRow( "Dit is een productomschrijving", 10.0, 12.10, FactuurRegelRow.BtwType.LAAG, date, "euro");
        List<FactuurRegelRow> factuurRegels = new ArrayList<FactuurRegelRow>();
        ...
        List<FactuurInfoRow> facturen = new ArrayList<FactuurInfoRow>();
        ...
        // klant 2
        FactuurRegelRow factuurRegel3 = new FactuurRegelRow( "Dit is een productomschrijving", 10.0, 12.10, FactuurRegelRow.BtwType.LAAG, date, "euro");
        List<FactuurRegelRow> factuurRegels2 = new ArrayList<FactuurRegelRow>();
        factuurRegels2.add(factuurRegel3);
        FactuurInfoRow factuur2 = new FactuurInfoRow(date, "12377", factuurRegels2);
        List<FactuurInfoRow> facturen2 = new ArrayList<FactuurInfoRow>();
